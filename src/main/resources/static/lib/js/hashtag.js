window.onload = function () {
    ...
    const miniheader = document.querySelector('#Box');
    const hashtag = document.querySelector('#header > .hashtag');
    ...
    function scrollFunc() {
        ...
        if (pageYOffset >= 5) {
            if(ww > 768){
                ...
                miniheader.style.marginTop = '-8rem';
            ...
            if(ww > 768){
                ...
                hashtag.style.marginTop = 'unset';
                miniheader.style.marginTop = 'unset';
...
$(document).on('click', '.like_img', function () {
    ...
    if (like[index] != 1) {
        like[index] = 1;
        const like_box = document.getElementsByClassName("like_img")[index];
