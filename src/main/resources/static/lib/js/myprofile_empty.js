...
function follower_up(){
    const popup = document.getElementById('background1');
...
function follower_down(){
    const popdown = document.getElementById('background1');
...
function following_up(){
    const popup = document.getElementById('background2');
    popup.style.display = "block";
    const body = document.querySelector('body');
    body.style.overflow = 'hidden'
}
...
function following_down(){
    const popdown = document.getElementById('background2');
    popdown.style.display = "none"
    const body = document.querySelector('body');
    body.style.overflow = 'unset'
}
